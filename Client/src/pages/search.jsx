...
export default function Search() {
  ...
  useEffect(() => {
    const fetchResorts = async () => {
      try {
        setLoading(true);
        const response = await fetch(`https://resort-booking-system-cizy.vercel.app/api/resorts`);
            ...
            <div className="search-grid">
              {filteredResorts.map((resort) => {
                ...
                const imageUrl = rawImageUrl 
                  ? (rawImageUrl.startsWith('/uploads') ? `https://resort-booking-system-cizy.vercel.app${rawImageUrl}` : rawImageUrl)
