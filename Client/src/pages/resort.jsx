    ...
    <div className="gallery-container">
      ...
      >
        ...
        <div className="hero-content">
          <p className="gallery-subtitle">Discover Luxury</p>
          ...
          {loading ? (
            ...
            <>
              <div className="resort-grid">
                {filteredResorts.slice(0, displayCount).map((resort, index) => (
                    <div
                    key={resort._id}
                    className="resort-item"
                    onClick={() => handleBookNow(resort._id)}
                  >
                    <img
                      src={resort.images?.[0]}
                      alt={resort.name}
              ...
              {filteredResorts.length > displayCount && (
                <div style={{ marginTop: '50px', textAlign: 'center' }}>
                  <span 
                    onClick={() => setDisplayCount(filteredResorts.length)}
                    style={{ 
                      cursor: 'pointer', 
                      fontSize: '1.1rem', 
                      fontWeight: '600', 
