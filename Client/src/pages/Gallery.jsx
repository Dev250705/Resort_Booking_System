...
export default function Gallery() {
  ...
  useEffect(() => {
    fetch(`http://${window.location.hostname}:5000/api/explore?type=gallery`)
      .then(r => r.json())
      .then(d => { if (d.success) setPhotos(d.content); })
      .catch(console.error);
  }, []);
  ...
  return (
    <>
      ...
      <div className="explore-page-container">
        <div className="explore-hero" style={{backgroundImage: `url('https://images.unsplash.com/photo-1610641818989-c2051b5e2cfd?auto=format&fit=crop&q=80&w=2000')`}}>
