...
export default function AdminReviews() {
  ...
  const loadPending = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`https://resort-booking-system-cizy.vercel.app/api/reviews/admin/pending`, {
  ...
  const approve = async (reviewId) => {
    ...
    try {
      const res = await fetch(
        `https://resort-booking-system-cizy.vercel.app/api/reviews/admin/${reviewId}/approve`,
        {
          method: "PATCH",
          headers: { Authorization: `Bearer ${getAuthToken()}` },
        }
  ...
  const reject = async (reviewId) => {
    ...
    setActionId(reviewId);
    try {
      const res = await fetch(`https://resort-booking-system-cizy.vercel.app/api/reviews/admin/${reviewId}`, {
        method: "DELETE",
        headers: { Authorization: `Bearer ${getAuthToken()}` },
      });
      const data = await res.json();
