...
export default function AdminContacts() {
  ...
  const fetchContacts = async () => {
    try {
      const res = await fetch(`https://resort-booking-system-cizy.vercel.app/api/contact/admin`, {
  ...
  const updateStatus = async (id, newStatus) => {
    try {
      const res = await fetch(`https://resort-booking-system-cizy.vercel.app/api/contact/admin/${id}`, {
        method: "PUT",
        headers: { 
