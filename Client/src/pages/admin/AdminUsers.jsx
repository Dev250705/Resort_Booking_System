...
export default function AdminUsers() {
  ...
  const loadUsers = async () => {
    setLoading(true);
    try {
      const res = await fetch(`https://resort-booking-system-cizy.vercel.app/api/users/admin/all`, {
  ...
  const toggleRole = async (userId, currentRole) => {
    ...
    try {
      const res = await fetch(`https://resort-booking-system-cizy.vercel.app/api/users/admin/${userId}/role`, {
        method: "PUT",
        headers: { 
